  ...
  return (
    <div ref={accordionRef} className="flex flex-col items-end">
      <button
        ...
        className={`shadow-primary-400 shadow-2xl border border-neutral-300 dark:border-neutral-700 flex justify-between items-center p-3 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-all duration-400 ease-[cubic-bezier(0.6,-0.4,0.5,1.5)] ${
          isOpen ? "w-full" : "w-11"
        }`}
      >
        <span
      ...
      <div
        className={`grid transition-all duration-300 ease-in-out ${
          isOpen ? "grid-rows-[1fr] w-full" : "grid-rows-[0fr] w-0"
        }`}
      >
